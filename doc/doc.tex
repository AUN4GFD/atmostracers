...
\fancyhead[L]{\texttt{atmostracers} documentation}
\fancyhead[R]{\textsc{\texttt{atmostracers} development team}}
\fancyfoot[C]{\thepage}
\addtolength\footskip{12pt}}
\definecolor{table_green}{rgb}{0, 0.6, 0}
\title{\texttt{atmostracers} Documentation}
\author{\texttt{atmostracers} Development Team}
\date{}
